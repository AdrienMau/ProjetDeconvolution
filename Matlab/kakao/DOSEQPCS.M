function doseqPCS(file, D, SeqLen, Opts)
%--------------------------------------------------------
% DOSEQPCS.M
% Complete evaluation of the image-file <file>:
% (i)   the particles are recognized (seqfind())
% (ii)  traces are generated (seqtrace())
% (iii) the msd is NOT calculated for each trace (msd())
%
%
% call: doseqLG (file, D, SeqLen, Opts)
%
...
%
% see also: seqtrc, seqfind, findpeak, clearpk, seqmsdLGzeros, fitopt, trace
%
%
% date:    25.7.1994
% author:  ts
