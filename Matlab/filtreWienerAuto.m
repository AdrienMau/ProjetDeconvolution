function [mu] = filtreWienerAuto(Data,RI,D,nbIterations)
...
%   nbIterations:
%Sortie:
%   mu: parametre bien pour la déconvolution

%Par Paul Letendre, et un peu Mau Adrien;
...
% Quelques tests
	if nargin~=3
	error('Ne sait faire que si 3 arguments en entrÃ©e')
	end
