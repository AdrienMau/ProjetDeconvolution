function cdata = guide_iconRead(filename,guessalpha)
% GUIDE_ICONREAD read an image file and convert it to CData for a HG icon.
%
% CDATA = GUIDE_ICONREAD(FILENAME)
...
%
% CDATA = GUIDE_ICONREAD(FILENAME, FALSE)
...
% uitoggletool('CData',guide_iconread(icon));
%
% See also IMREAD.
